---
title: "Host Uptime (Hyper-V)"
product: "vone"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/one/userguide/host_uptime_hyperv.html"
...
* The Uptime Distribution chart shows uptime values of all available hosts.

* The Host Uptime table provides the list of hosts whose uptime values are not within the specified thresholds.

Click a host name in the Host column to drill down to details on alarms triggered by Veeam ONE Client and host restarts.
...
[![Host Uptime Report](images/hyperv_host_uptime.webp)](images/hyperv_host_uptime.webp "Host Uptime Report")
