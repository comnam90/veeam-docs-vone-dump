---
title: "Date and Time Format in Reports"
product: "vone"
doc_type: "userguide"
...
Most Veeam ONE reports include date and time details. The format of date and time in reports depends on the browser you use to work with Veeam ONE Web Client.

If you use Chrome, Firefox or Edge the date and time format will be determined by language preferences (locale) set in the browser.
