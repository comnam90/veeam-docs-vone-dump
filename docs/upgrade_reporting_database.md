---
title: "Step 8. Choose Reporting Database"
product: "vone"
doc_type: "userguide"
...
At the Reporting Database step of the wizard, choose a PostgreSQL Server instance that will host the Veeam ONE database.
