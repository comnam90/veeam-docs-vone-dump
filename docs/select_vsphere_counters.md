...
product: "vone"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/one/userguide/select_vsphere_counters.html"
...
4. From the Chart views list, select the Custom option to open the Select Devices and Counters window.
5. From the Devices list, select the necessary resource device(s).
...
[![Select Chart Views and Performance Counters](images/select_devices_counters.webp)](images/select_devices_counters.webp "Select Chart Views and Performance Counters")
