---
title: "vSphere Raw Performance Data"
product: "vone"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/one/userguide/vmware_raw_performance.html"
last_updated: "2026"
product_version: "13.1.0.7034"
---

# vSphere Raw Performance Data


This report allows you to get detailed raw data on specific CPU, memory, network, storage and disk metrics to analyze performance of VMware hosts, VMs and datastores.
...
* Measured Entities: defines subsystems to analyze in the report (CPU, Memory, Network, Storage Adapter, Storage Path, Datastore or Power). The list of available subsystems will depend on the selected object type.
...
[![vSphere Raw Performance Data Report](images/vmware_raw_performance_01.webp)](images/vmware_raw_performance_01.webp "vSphere Raw Performance Data Report")
[![vSphere Raw Performance Data Report](images/vmware_raw_performance_02.webp)](images/vmware_raw_performance_02.webp "vSphere Raw Performance Data Report")
