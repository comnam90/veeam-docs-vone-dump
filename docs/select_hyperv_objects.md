...
product: "vone"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/one/userguide/select_hyperv_objects.html"
...
[![Select Objects to Chart](images/hyperv_customize_chart_options.webp)](images/hyperv_customize_chart_options.webp "Select Objects to Chart")

To display performance data for a set of VMs in the selected virtual infrastructure segment:
...
[![Select Objects to Chart](images/hyperv_select_objects_to_chart.webp)](images/hyperv_select_objects_to_chart.webp "Select Objects to Chart")
