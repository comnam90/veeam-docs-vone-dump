...
* Job type: defines a job type to evaluate in the report (Backup to tape, Cloud Director backup, Cloud Director replication, File backup, File copy, File to tape, Nutanix backup, Replication, VM backup, VM copy, All and Add Object Storage).
