...
* In the Format Type section, select the Report format (PDF or CSV), Page format, and Page orientation (portrait or landscape) for the report. If required, select the Use actual width check box.
