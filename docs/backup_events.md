---
title: "Veeam Backup & Replication Events"
product: "vone"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/one/userguide/backup_events.html"
...
The Tasks & Events dashboard shows the history of events that triggered Veeam Backup & Replication alarms. For the list and detailed description of data protection alarms, see [Veeam Backup & Replication Alarms](backup_alarms_events.md).
...
[![Veeam Backup & Replication Events](images/backup_monitoring_events.webp)](images/backup_monitoring_events.webp "Veeam Backup & Replication Events")
