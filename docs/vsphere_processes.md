---
title: "VMware vSphere In-Guest Processes"
product: "vone"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/one/userguide/vsphere_processes.html"
last_updated: "5/12/2025"
product_version: "13.0.1.6168"
---

# VMware vSphere In-Guest Processes
...
3. Open the Guest OS tab and navigate to Processes.
...
3. To view the detailed description of a counter, click it in the Counters list. The description will be displayed in the lower pane of the window.
...
* [For Windows-based machines] To create an alarm, select one or more processes in the list, click the Create Alarm button, and select the type of rule on which the alarm must be based. For details on alarm rules, see [Alarm Rules](rules.md).
